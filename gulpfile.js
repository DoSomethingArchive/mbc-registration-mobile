...
gulp.task('phpcbf', shell.task(['vendor/bin/phpcbf --standard=PSR2 --ignore=vendor/,node_modules/,messagebroker-config src mbc-registration-email_userRegistration.php mbc-registration-email_userRegistration.config.inc']));
